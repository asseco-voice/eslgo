# eslgo
[![PkgGoDev](https://pkg.go.dev/badge/github.com/asseco-voice/eslgo)](https://pkg.go.dev/github.com/asseco-voice/eslgo)
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/percipia/eslgo/Go)
[![Go Report Card](https://goreportcard.com/badge/github.com/asseco-voice/eslgo)](https://goreportcard.com/report/github.com/asseco-voice/eslgo)
...
[![GitHub license](https://img.shields.io/github/license/percipia/eslgo)](https://github.com/asseco-voice/eslgo/blob/v1/LICENSE)
...
## Install
```
go get github.com/asseco-voice/eslgo
```
```
github.com/asseco-voice/eslgo v1.3.3
```
